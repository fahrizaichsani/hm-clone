...
export default function DetailProduct() {
  return (
    <>
      ...
      <div className="max-w-[1160px] mx-[35px] flex justify-start items-start mb-[120px]">
        <div className="w-[480px] flex flex-row gap-[4px] mt-[50px]">
          ...
          <div className="flex flex-col justify-start items-start pl-[30px] mt-[30px]">
            <div className="w-[463px] font-sans flex flex-col">
            ...
            <div className="flex flex-row w-[420px] mt-[10px] font-sans gap-[6px]">
              <img
